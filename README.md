...
이런 대체성은 [객체 지향 프로그래밍의 원칙]([robert martin](https://github.com/foryouself83/DesignPattern/edit/master/README.md#%EA%B0%81%EC%A3%BC)) 중 하나인 `리스코프 치환의 원칙(다형성)` 이라는 핵심 개념이다.   
